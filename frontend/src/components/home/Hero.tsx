        ...
        <div className="py-20 md:py-32">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-3xl">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-accent/10 rounded-full mb-8">
              ...
              {/* Headline */}
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-header-foreground leading-tight mb-6">
                High-Quality Refurbished Electronics{" "}
                <span className="text-green-accent">You Can Trust</span> 
              </h1>

              {/* Subtext */}
              <p className="text-lg md:text-xl text-footer-foreground leading-relaxed mb-8">
            ...
            <div className="relative flex justify-center items-center">
              {/* Soft green glow */}
              <div className="absolute -inset-12 bg-green-500/20 blur-3xl rounded-full" />
              ...
              <img
               src={heroVisual}
               alt="Certified refurbished electronics"
